...
def ejecutar_encontrar_estrenos(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    Parametros:
        ...
        p5 (dict): Diccionario que contiene la informacion de la pelicula 5.
    """
    anio=int(input("ingrese el año de estreno de la pelicula"))
...
def ejecutar_reagendar_pelicula(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        horario=int(input("ingrese un numero horario para la pelicula: "))
        dia=input("ingrese un nuevo dia para agendar la pelicula: ")
        preferencias=int(input("desea tener en cuenta las preferencias: 1 para si o 0 para no: "))
        if mod.reagendar_pelicula(pelicula,horario,dia,preferencias,p1,p2,p3,p4,p5)==True:
            print("la pelicula puede ser reagendada")
        else : 
            print("no es posible reagendar la pelicula")
...
def ejecutar_decidir_invitar(p1: dict, p2: dict, p3: dict, p4: dict, p5: dict)->None:
    ...
    if pelicula is None:
        ...
        autorizacion_padres=bool(input("ingrese la autorizacion:1 para si o 0 para no: "))
        retorno=mod.decidir_invitar(pelicula,edad_invitado,autorizacion_padres)
        if retorno==True :
            print("si es posible invitar a esta persona")
        else : 
            print("no es posible invitar a esta persona")    
